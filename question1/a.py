...
def run():
    ...
    info(net['r1'].cmd('ip route add 10.0.0.0/24 via 5.0.2.1 dev r1-eth3')) #r1 connects to r3
    ...
    info(net['r3'].cmd('ip route add 192.168.1.0/24 via 5.0.2.2 dev r3-eth2')) #r3 connects to r1
